...
const quizData = [
    ...
    {
        question: 'מי היה הרמטכ"ל במלחמת יום הכיפורים?',
        options: ["דוד אלעזר", "יצחק רבין", "אביב כוכבי"],
        answer: "דוד אלעזר",
    },
    {
        question: 'נשיא מצרים בתקופת מלחמת יום הכיפורים היה',
        options: ["מחמד אצחי", "אנואר סדאת'", "מרדול אמינו"],
        answer: "אנואר סדאת'",
    },
    {
        question: 'מבצע "אבירי לב" במלחמת יום הכיפורים היה המבצע של...',
        options: ["חציית תעלת סואץ", "כיבוש צפון מצריים", "לא היה מבצע כזה."],
        answer: "חציית תעלת סואץ",
    },
];
